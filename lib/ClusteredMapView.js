import React, { memo, useState, useEffect, useMemo, createRef, useCallback } from "react";
...
const ClusteredMapView = ({
  ...
  return (
    ...
    >
      <Markers onPress={_onClusterPress} 
               markers={markers}
...
const Markers = memo(({ propsChildren, renderCluster, markers, onPress, clusterColor, clusterTextColor }) => {
